...
public class TeleopDriveArcade extends Command {
  ...
  public void execute() {
    ...
    steering *= (0.5+0.5*throttle);

    //TODO tackle the following tasks one at a t  ime in order
    //you may make any private functions needed
    //you may google and ask questions as needed.

    //TODO Impliment the diffDrive subsystem and make it drive (done)
    ...
    //TODO Make the robot turn, now drive at speed and make it turn, what changes (done)
